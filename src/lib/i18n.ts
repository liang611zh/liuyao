...
'zh-CN': {
  ...
  account_nickname_placeholder: '给自己起个名字',
  btn_save_nickname: '保存昵称',
  account_nickname_saved: '已保存',
  btn_sign_out: '退出登录',
...
'zh-TW': {
  ...
  account_nickname_label: '暱稱',
  account_nickname_placeholder: '給自己取個名字',
  btn_save_nickname: '儲存暱稱',
  account_nickname_saved: '已儲存',
  btn_sign_out: '登出',
...
'en': {
  ...
  account_nickname_placeholder: 'What should we call you?',
  btn_save_nickname: 'Save nickname',
  account_nickname_saved: 'Saved',
...
'ja': {
  ...
  account_nickname_placeholder: '呼び名を決めてください',
  btn_save_nickname: 'ニックネームを保存',
  account_nickname_saved: '保存しました',
  btn_sign_out: 'ログアウト',
...
'ko': {
  ...
  account_nickname_placeholder: '어떻게 불러드릴까요?',
  btn_save_nickname: '닉네임 저장',
  account_nickname_saved: '저장됨',
  btn_sign_out: '로그아웃',
